...
class Aauth {
	 ...
	 */
	public function create_user($email, $pass, $name, $first_name, $last_name, $other_name, $access_level) {
		...
		if ( $this->aauth_db->insert($this->config_vars['users'], $data )){
			...
			$this->add_member($user_id, $access_level);	
		}
	 ...
	 * @return bool Update fails/succeeds
	 */
	public function update_user($user_id, $email = FALSE, $pass = FALSE, $name = FALSE, $first_name, $last_name, $other_name, $company, $phone, $address) {
